    ...
    ui(new Ui::MainWindow)
{
 ...
 ui->qrcodepixmapLabel->setAttribute(Qt::WA_TranslucentBackground);//background transparente ez
    QPixmap pix("C:/Users/trashousha/Desktop/inesyatrash/testing/Section/welcome2.png"); //inserer une image
   ...
   QPixmap pix3("C:/Users/trashousha/Desktop/inesyatrash/testing/Section/english.png"); //inserer une image
   QIcon ButtonIcon(pix3);
   ui->pushButton_14->setIcon(ButtonIcon);

   QMovie *movie=new QMovie("C:/Users/trashousha/Desktop/inesyatrash/testing/Section/ezgif.com-resize.gif");
